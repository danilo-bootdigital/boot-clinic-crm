...
import { validateWhatsappMedia, type MediaValidationResult } from '@/lib/messaging/media-config';
...
// Bucket criado na fase WhatsApp; mantém o nome por ser infraestrutura já
// provisionada no Supabase. Serve mídia de TODOS os canais da mensageria.
...
export interface MessagingUploadInput {
  companyId: string;
...
export async function uploadMessagingMedia(input: MessagingUploadInput): Promise<MessagingUploadResult> {

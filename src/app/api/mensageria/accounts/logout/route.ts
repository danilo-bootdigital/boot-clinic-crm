...
import { getPrimaryInstance, logoutInstance, instanceSummary, isEvolutionConfigured } from '@/lib/messaging/adapters/whatsapp/evolution';

// POST /api/mensageria/accounts/logout
  ...
  try {
    ...
    const updated = await prisma.channelAccount.update({
      ...
      data: {
        ...
        // QR morre com a sessão: remove do providerConfig.
        providerConfig: waConfigPatch(instance, { qrCode: null }),
      },
    });
